...
//	@RequestMapping(value = "/ticket", method = RequestMethod.POST, consumes = MediaType.APPLICATION_JSON_UTF8_VALUE)
//	@ResponseBody
//	public ResponseDTO creatTicketnew(@RequestBody TicketDTO ticketdto) throws ControllerException {
//		
...
//	@RequestMapping(value = "/ticket", method = RequestMethod.PUT, consumes = MediaType.APPLICATION_JSON_UTF8_VALUE)
//	@ResponseBody
//	public ResponseDTO updateTicket(@RequestBody TicketDTO ticketdto) throws ControllerException {
//		return ticketfacadeService.updateTicket(ticketdto);
//	}
//	
...
//		return ticketfacadeService.deleteTicket(ticketId);
//	}
//
