...
export class AttachmentService {
  ...
  private attachmentsUrl = 'http://192.168.2.113:8082/HelpDeskIntegrationAPI/api/attachment';  // URL to web api
  ...
  getAttachmentByTickId(ticketID: number): Observable<AttachmentResponse> {
    const href = 'http://192.168.2.113:8082/HelpDeskIntegrationAPI/api/attachment/ticid/'+ticketID;
  ...
  addAttachment(formData: FormData) {
    const href = 'http://192.168.2.113:8082/HelpDeskIntegrationAPI/api/attachment';
  ...
  /* addAttachment(formData: FormData): Observable<FormData> {
    ...
    this.apiEndPoint = 'http://192.168.2.113:8082/HelpDeskIntegrationAPI/ticket';
