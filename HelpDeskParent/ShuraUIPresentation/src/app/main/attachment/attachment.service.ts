...
export class AttachmentService {
  ...
  private attachmentsUrl = 'http://localhost:8082/HelpDeskIntegrationAPI/api/attachment';  // URL to web api
  ...
  getAttachmentByTickId(ticketID: number): Observable<AttachmentResponse> {
    const href = 'http://localhost:8082/HelpDeskIntegrationAPI/api/attachment/ticid/'+ticketID;
  ...
  addAttachment(formData: FormData) {
    const href = 'http://localhost:8082/HelpDeskIntegrationAPI/api/attachment';
  ...
  /* addAttachment(formData: FormData): Observable<FormData> {
    ...
    this.apiEndPoint = 'http://localhost:8082/HelpDeskIntegrationAPI/ticket';
