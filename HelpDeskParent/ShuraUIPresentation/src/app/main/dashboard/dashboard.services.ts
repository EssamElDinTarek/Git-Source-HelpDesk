...
export class DashBoardService //implements Resolve<any>
{
    ...
    getTicketsCounts(projectID:number,userEmail:string): Observable<any> {
        ...
        const href = 'http://localhost:8081/HelpDeskIntegrationAPI/api/ticket/dashboardcountountprojectidandusername';
        const requestUrl = `${href}?PROJECT_ID=` + projectID + `&USER_EMAIL=` + userEmail
    ...
    getWeeklyTickets(projectId:Number): Observable<any> {
        ...
        const href = 'http://localhost:8081/HelpDeskIntegrationAPI/api/ticket/dashboardweekchartstatusescount';
        const requestUrl = `${href}?PROJECT_ID=`+projectId;
    ...
    getProjectChart(): Observable<any> {
        ...
        const requestUrl = 'http://localhost:8081/HelpDeskIntegrationAPI/api/portfolio/dashboardweekchartprojectscount';
    ...
    getTeamsPerProject(projectID): Observable<any> {
        ...
        const href = 'http://localhost:8081/HelpDeskIntegrationAPI/api/team/projectmemberandcount';
        const requestUrl = `${href}?PROJECT_ID=`+projectID;
    ...
    getProjectsByPortofolioID(portofloioId:Number): Observable<any> {
        ...
        const href = ' http://localhost:8081/HelpDeskIntegrationAPI/api/project/getByPortfolioId';
    ...
    getProjectDetailsByPortofolioID(portofolioId:Number): Observable<any> {
        ...
        const href = 'http://localhost:8081/HelpDeskIntegrationAPI/api/project/projectdbdetails';
        ...
        const requestUrl = 'http://localhost:8081/HelpDeskIntegrationAPI/api/portfolio/portfoliodbdetails';
    ...
    getAllPortofolios(): Observable<any> {
        ...
        const requestUrl = 'http://localhost:8081/HelpDeskIntegrationAPI/api/portfolio';
    ...
    getUsersByPortofolioID(portofloioId:Number): Observable<any> {
        ...
        const href = 'http://localhost:8081/HelpDeskIntegrationAPI/api/user/allbyportfolioid';
        const requestUrl = `${href}?PORTFOLIO_ID=`+portofloioId;
