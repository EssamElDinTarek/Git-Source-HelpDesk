export class ManagerDashboardDb
{
            ...
            'table': {
                ...
                'rows'   : [
                    [
                        ...
                        {
                            'value'  : 'Project on going normally.',
                            'classes': 'text-bold',
                            'icon'   : ''
                        }
                    ],
                    ...
                    [
                        ...
                        {
                            'value'  : 'Tickets were added to backlog.',
                            'classes': 'text-bold',
                            'icon'   : ''
                        }
                    ],
                    [
                        ...
                        {
                            'value'  : 'Message broker project to be switched to bug fix phase.',
                            'classes': 'text-bold',
                            'icon'   : ''
                        }
                    ],
