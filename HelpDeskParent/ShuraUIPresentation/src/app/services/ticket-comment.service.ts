...
export class TicketCommentService {
  ...
  private commentUrl = 'http://192.168.3.125:8082/HelpDeskIntegrationAPI/api/ticketcomment';  // URL to web api
  ...
  getCommentByTickId(ticketID: number): Observable<CommentResponse> {
    const href = 'http://192.168.3.125:8082/HelpDeskIntegrationAPI/api/ticketcomment/tickid/' + ticketID;
  ...
  addTicketComment(comment: TicketComment) {/*
    ...
    return this._http.post('http://192.168.3.125:8082/HelpDeskIntegrationAPI/api/ticketcomment', comment, {
