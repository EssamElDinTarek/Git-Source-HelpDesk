...
export class TicketService //implements Resolve<any>
{
   ...
   */
    ...
    getTicketSeverity(): Observable<SeverityResponse> {
        return this._httpClient.get<SeverityResponse>('http://192.168.2.113:8082/HelpDeskIntegrationAPI/api/ticketseverity', {
    ...
    stepTicketForward(ticketID: number): Observable<Ticket> {
        ...
        return this._httpClient.get<Ticket>('http://192.168.2.113:8082/HelpDeskIntegrationAPI/api/ticket/stepTicketForward?TICKET_ID=' + ticketID, {
            headers: this.headers
        })
            .pipe(
                //catchError(/*this.handleError('addHero', ticket)*/)
    ...
    stepTicketBackward(ticketID: number): Observable<Ticket> {
        ...
        return this._httpClient.get<Ticket>('http://192.168.2.113:8082/HelpDeskIntegrationAPI/api/ticket/stepTicketBackward?TICKET_ID=' + ticketID, {
            headers: this.headers
        })
            .pipe(
            );
    ...
    getUserDetails(userMail: string): Observable<User> {
        ...
        return this._httpClient.get<User>('http://192.168.2.113:8082/HelpDeskIntegrationAPI/api/getUserByEmail?value='+userMail, {
            headers: this.headers
        })
            .pipe(
            );
    ...
    getWorkflow(): Observable<WorkFlowResponse> {
        ...
        return this._httpClient.get<WorkFlowResponse>('http://192.168.2.113:8082/HelpDeskIntegrationAPI/api/workflow', {
            headers: this.headers
        })
            .pipe(
            );
    ...
    getTicketById(value: string): Observable<Ticket> {
        ...
        const href = 'http://192.168.2.113:8082/HelpDeskIntegrationAPI/api/ticket';
    ...
    getTicketPriority(): Observable<PriorityResponse> {
        ...
        return this._httpClient.get<PriorityResponse>('http://192.168.2.113:8082/HelpDeskIntegrationAPI/api/ticketpriority', {
            headers: this.headers
        })
            .pipe(
                //catchError(/*this.handleError('addHero', ticket)*/)
    ...
    addTicket(formData: FormData): Observable<Ticket> {
        ...
        return this._httpClient.post<Ticket>('http://192.168.2.113:8082/HelpDeskIntegrationAPI/api/ticket', formData, {
    ...
    editTicket(formData: FormData): Observable<Ticket> {
        ...
        return this._httpClient.post<Ticket>('http://192.168.2.113:8082/HelpDeskIntegrationAPI/api/ticket/update', formData, {
        })
    ...
    getTicketsByProjectID(projectId:number,userEmail:string): Observable<any> {
        const href = 'http://192.168.2.113:8082/HelpDeskIntegrationAPI/api/ticket/ticketbyproidanduser';
    ...
    getTicketsByProjectName(projectName:string): Observable<any> {
        const href = 'http://192.168.2.113:8082/HelpDeskIntegrationAPI/api/ticket/list';
        //const requestUrl = `${href}?PROJECT_ID=1&USER_EMAIL=ahmed.farrag`;
    ...
    getTicketsByWorkFlowID(): Observable<any> {
        ...
        const href = 'http://192.168.2.113:8082/HelpDeskIntegrationAPI/api/ticket/ticketbywfidanduser';
    ...
    getWorkFlowList(): Observable<any> {
        ...
        const href = 'http://192.168.2.113:8082/HelpDeskIntegrationAPI/api/workflow';
        //const requestUrl = `${href}?WORKFLOW_ID=2&USER_EMAIL=ahmed.farrag`;
    ...
    getCategorizationList(): Observable<any> {
        ...
        const href = 'http://192.168.2.113:8082/HelpDeskIntegrationAPI/api/ticket/severityprioritystatusbyuser';
   ...
   /*  getCurrentWeatherRequestURL(): any {
    ...
    getCurrentWeather(lat:Number,lon:Number):Observable<any> {
        ...
        getUsersByProjectID():Observable<any>{
            console.log('Start Calling getCategorizationList service...!');
            const href = 'http://192.168.2.113:8082/HelpDeskIntegrationAPI/api/user/allbyprojectid';
        ...
        getTicketHistoryByID(ticketID):Observable<any>{
            ...
            const href = 'http://192.168.2.113:8082/HelpDeskIntegrationAPI/api/ticket/history?TICKET_ID='+ticketID;
